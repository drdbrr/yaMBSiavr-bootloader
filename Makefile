MCU		=	atmega328p
PROJECTNAME	=	garden_acs
PROJECTSRC	=	main.c yaMBSiavr.c twi_master/twi_master.c
F_CPU		=	16000000UL
...
EXTMEMOPTS = -Wl,--section-start=.text=$(BOOTLOADER_START_ADDRESS)
